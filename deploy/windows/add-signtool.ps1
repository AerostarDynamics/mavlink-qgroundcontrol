<##
#   Locate Windows signtool.exe and update the Windows
#   PATH variable to include the path to signtool.
#>
...
try {
    ...
    "Added " + $Tool.Directory.FullName + " to $" + "env:GITHUB_PATH and $" + "env:PATH"
